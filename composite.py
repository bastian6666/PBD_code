...
band10_paths = ['2023_12_27/ST_B10.TIF', '2024_01_21/ST_B10.TIF']

# Determine the target CRS, transform, and shape based on the first image of band 4
with rasterio.open(band4_paths[0]) as src:
    target_crs = src.crs
...
output_paths = ['composite_band_4.tif', 'composite_band_5.tif', 'composite_band_10.tif']
for band, output_path in zip([band4_composite_avg, band5_composite_avg, band10_composite_avg], output_paths):
